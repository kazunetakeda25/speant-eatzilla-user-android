...
public class FavRestaurantAdapter extends RecyclerView.Adapter<FavRestaurantAdapter.Viewholder> {
    private static final String TAG = "FavRestaurantAdapter" ;
    Context context;
    List<FavResResponse.FavouriteList> favouriteLists;
    SessionManager sessionManager;
    APIInterface apiInterface;
    onFavouritesClick onfavouritesClick;

    public FavRestaurantAdapter(Context context, List<FavResResponse.FavouriteList> favouriteLists, onFavouritesClick onfavouritesClick) {
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, int position) {
        FavResResponse.FavouriteList pojo = favouriteLists.get(position);
       ...
       /* holder.hotelDetailTimeTxt.setText("" + pojo.getTravel_time());
        ...
        Log.e("Giri ", "onBindViewHolder:IsFavourite "+pojo.getIsFavourite() );
        ...
        holder.hotelLikeImg.setOnLikeListener(new OnLikeListener() {
            ...
            public void liked(LikeButton likeButton) {
                if(sessionManager.isLoggedIn()){
                    Log.e(TAG, "liked: " +favouriteLists.get(holder.getAdapterPosition()).getRestaurant_id());
                    HashMap<String,String> map = new HashMap<>();
                    map.put("restaurant_id", String.valueOf(favouriteLists.get(holder.getAdapterPosition()).getRestaurant_id()));
                    jsonLikeUpdate(map);
                }else{
                    holder.hotelLikeImg.setLiked(false);
            ...
            public void unLiked(LikeButton likeButton) {
                if(sessionManager.isLoggedIn()) {
                    Log.e(TAG, "unLiked: " +favouriteLists.get(holder.getAdapterPosition()).getRestaurant_id());
                    HashMap<String,String> map = new HashMap<>();
                    map.put("restaurant_id", String.valueOf(favouriteLists.get(holder.getAdapterPosition()).getRestaurant_id()));
                    jsonLikeUpdate(map);
                }else{
            ...
            public void onResponse(Call<SuccessPojo> call, Response<SuccessPojo> response) {
                ...
                if (response.code()==200){
                    ...
                    if (response.body().getStatus()){
                        ((FavouritesActivity)context).getFavouriteList();
                    }else
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    CONST.restaren_id = String.valueOf(favouriteLists.get(getAdapterPosition()).getRestaurant_id());
