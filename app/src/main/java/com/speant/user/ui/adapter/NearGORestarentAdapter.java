...
public class NearGORestarentAdapter extends RecyclerView.Adapter<NearGORestarentAdapter.ViewHolder> {
    ...
    DiningRestaurantClick diningRestaurantClick;
    ...
    public NearGORestarentAdapter(Context context, List<NearRestarentPojo.Restaurants> nearRestarentList, onFavouritesClick onfavouritesClick, DiningRestaurantClick diningRestaurantClick) {
        this.restarentPojoList = nearRestarentList;
        mContext = context;
        sessionManager = new SessionManager(context);
        this.diningRestaurantClick =diningRestaurantClick;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   ...
                   diningRestaurantClick.onDiningRestaurantClick(restarentPojoList.get(getAdapterPosition()));
